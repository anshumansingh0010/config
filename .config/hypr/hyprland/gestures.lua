...
-- hl.gesture({ fingers = vars.gestureFingersMore, direction = "up",   action = "hyprexpo:expo on" })
-- hl.gesture({ fingers = vars.gestureFingersMore, direction = "down",  action = "hyprexpo:expo off" })
