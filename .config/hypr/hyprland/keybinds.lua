...
hl.bind("SUPER + SHIFT + T", hl.dsp.exec_cmd(home .. "/.scripts/wallpaper.sh"))
hl.bind("SUPER + SHIFT + R", hl.dsp.exec_cmd("variety --next"))
...
hl.bind(vars.kbToggleSpecialWs, hl.dsp.exec_cmd("caelestia toggle specialws"))
...
hl.bind("Insert",                      hl.dsp.window.close())
hl.bind("XF86Favorites",              hl.dsp.window.close())

-- Script-based keybinds
hl.bind(vars.kbResizeToCenter, hl.dsp.exec_cmd(scripts .. "/resizetocenter.sh"))
hl.bind(vars.MvkbTodo,         hl.dsp.exec_cmd(scripts .. "/toggleworkspace.sh"))
...
hl.bind("SUPER + W",          hl.dsp.exec_cmd("app2unit -- firefox"))
...
hl.bind("XF86Calculator",     hl.dsp.exec_cmd("app2unit -- gnome-calculator"))

-- Utilities
hl.bind("Print",                hl.dsp.exec_cmd("caelestia screenshot"),         { locked = true })  -- Full screen capture > clipboard
hl.bind("SUPER + SHIFT + S",   hl.dsp.global("caelestia:screenshotFreeze"))                         -- Capture region (freeze)
hl.bind("SUPER + SHIFT + ALT + S", hl.dsp.global("caelestia:screenshot"))                          -- Capture region
...
hl.bind("CTRL + SHIFT + Delete", hl.dsp.global("caelestia:session"))
...
hl.bind(
    "CTRL + SHIFT + ALT + V",
    hl.dsp.exec_cmd('sleep 0.5s && ydotool type -d 1 "$(cliphist list | head -1 | cliphist decode)"'),  -- Alternate paste
    { locked = true }
)
...
-- Tag handler scripts
hl.bind("SUPER + J",         hl.dsp.exec_cmd(scripts .. "/tagHandler.py"),    { release = true })
hl.bind("SUPER + SHIFT + J", hl.dsp.exec_cmd(scripts .. "/tagHandlerall.py"), { release = true })
hl.bind("SUPER + B",         hl.dsp.exec_cmd(scripts .. "/bar.py"),           { release = true })
hl.bind("SUPER + SHIFT + B", hl.dsp.exec_cmd(scripts .. "/shaderhandler.py"), { release = true })
